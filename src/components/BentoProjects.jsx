      ...
      >
        ...
        <div className={`relative ${getAspectRatio()} overflow-hidden`}>
          ...
          <div className="absolute inset-0 flex items-center justify-center 
            bg-blue-500/20 backdrop-blur-[2px] opacity-0 group-hover:opacity-100 
            transition-opacity duration-300 pointer-events-none">
            <span className="px-4 py-2 bg-white/90 dark:bg-black/90 rounded-full 
              text-sm font-medium text-gray-900 dark:text-white shadow-lg">
              Lihat Detail
            </span>
          </div>
        </div>
