...
const DecayCard = ({ width = 300, height = 400, image = 'https://picsum.photos/300/400?grayscale', children }) => {
  ...
  // <-- 1. Tambahkan state untuk mendeteksi hover
  const [isHovered, setIsHovered] = useState(false);

  useEffect(() => {
    // ... (kode useEffect lainnya biarkan sama, tidak perlu diubah) ...
  ...
  return (
    // <-- 2. Tambahkan event handler onMouseEnter dan onMouseLeave
    <div
      ref={svgRef}
      className="relative"
    ...
    >
      ...
      >
        {/* Filter untuk efek decay (bawaan) */}
        <filter id="imgFilter">
          <feTurbulence
            type="turbulence"
            baseFrequency="0.015"
        ...
        {/* <-- 3. Tambahkan filter baru untuk grayscale */}
        ...
        <g>
          <image
            ...
            // <-- 4. Terapkan filter secara kondisional dan tambahkan transisi
            filter={isHovered ? "url(#imgFilter)" : "url(#imgFilter) url(#grayscaleFilter)"}
